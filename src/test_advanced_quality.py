# test_advanced_quality.py - СОЗДАТЬ НОВЫЙ ФАЙЛ
import sys
import os
import pandas as pd
...
def test_advanced_quality():
    """Тестирование качества улучшенного гибридного поиска"""

    config = Config()

    print("🧪 Testing ADVANCED HYBRID Search Quality")
    print("=" * 60)
    ...
    print(f"\n📊 Advanced hybrid index info: {index_info}")


if __name__ == "__main__":
    test_advanced_quality()